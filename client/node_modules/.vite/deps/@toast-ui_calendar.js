            ...
            var TimePicker = defineClass(
              /** @lends TimePicker.prototype */
              {
                ...
                compareTimes: function(begin, end) {
                  var first2 = /* @__PURE__ */ new Date(0);
...
var import_tui_date_picker = __toESM(require_tui_date_picker(), 1);
...
var f$3 = {};
var e$1 = [];
var c$3 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i;
function s$3(n2, l2) {
  for (var u2 in l2)
    n2[u2] = l2[u2];
  return n2;
...
var G;
var U;
var W$1 = typeof Symbol != "undefined" && typeof Symbol("x") == "symbol";
var X = typeof Map != "undefined";
var q$1 = typeof Set != "undefined";
var B = typeof Proxy != "undefined" && Proxy.revocable !== void 0 && typeof Reflect != "undefined";
var H$1 = W$1 ? Symbol.for("immer-nothing") : ((G = {})["immer-nothing"] = true, G);
var L$1 = W$1 ? Symbol.for("immer-draftable") : "__$immer_draftable";
var Q$1 = W$1 ? Symbol.for("immer-state") : "__$immer_state";
var Z$1 = "" + Object.prototype.constructor;
...
var UTCDate = class _UTCDate extends LocalDate {
  clone() {
    return new _UTCDate(this.d);
  }
  getTimezoneOffset() {
    return 0;
  }
...
var TZDate = class _TZDate {
  constructor(...args) {
    this.tzOffset = null;
    if (args[0] instanceof _TZDate) {
  ...
  tz(tzValue) {
    if (tzValue === "Local") {
      return new _TZDate(this.getTime());
    }
    const tzOffset = isString_1(tzValue) ? calculateTimezoneOffset(tzValue, this) : tzValue;
    const newTZDate = new _TZDate(this.getTime() - getTZOffsetMSDifference(tzOffset));
  ...
  local(tzValue) {
    if (isPresent(tzValue)) {
      const tzOffset = isString_1(tzValue) ? calculateTimezoneOffset(tzValue, this) : tzValue;
      return new _TZDate(this.getTime() + getTZOffsetMSDifference(tzOffset));
    }
    return new _TZDate(this.getTime() + (isPresent(this.tzOffset) ? getTZOffsetMSDifference(this.tzOffset) : 0));
  }
};
...
var EventUIModel = class _EventUIModel {
  constructor(event) {
    this.top = 0;
    this.left = 0;
    this.width = 0;
  ...
  collidesWith(uiModel, usingTravelTime = true) {
    ...
    [this, uiModel].forEach((event) => {
      const isDuplicateEvent = event instanceof _EventUIModel && event.duplicateEvents.length > 0;
      if (isDuplicateEvent) {
        infos.push({
  ...
  clone() {
    ...
    const clonedEventUIModel = new _EventUIModel(this.model);
...
var Collection = class _Collection {
  ...
  groupBy(groupByFn) {
    ...
    this.internalMap.forEach((item) => {
      ...
      (_a = result[key]) != null ? _a : result[key] = new _Collection(this.getItemID);
      result[key].add(item);
    });
    return result;
  }
...
var DraggingState = ((DraggingState2) => {
...
var templates = {
  ...
  time(model) {
    ...
    if (start) {
      return h$3("span", null, h$3("strong", null, toFormat(start, "HH:mm")), " ", h$3("span", null, stripTags(title)));
    }
...
var isSSR = isUndefined_1(window) || !window.navigator;
var useIsomorphicLayoutEffect = isSSR ? _$2 : h$2;
...
function GridHeader({
  ...
  return h$3("div", {
    ...
    style: { marginLeft }
  }, dayNames.map((dayName, index) => h$3(DayName, {
    type,
...
var getWeekViewEvents = (row, calendarData, {
  narrowWeekend,
  hourStart,
  hourEnd,
  weekStartDate,
...
var P = /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|marker(?!H|W|U)|overline|paint|shape|stop|strikethrough|stroke|text(?!L)|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/;
...
function ExceedCount({ index, exceedCount, isClicked, onClickExceedCount }) {
  ...
  return exceedCount && !isClicked ? h$3("span", {
...
function CollapseButton({ isClicked, isClickedIndex, onClickCollapseButton }) {
  return isClicked && isClickedIndex ? h$3("span", {
    className: cls("weekday-exceed-in-week"),
...
var GridCells = g$1(function GridCells2({
  uiModels,
  weekDates,
  narrowWeekend,
  height,
  ...
  return h$3(p$3, null, weekDates.map((cell, index) => {
...
function HorizontalEvent({
  ...
  return h$3("div", {
    ...
    param: uiModel.model
  })), !shouldHideResizeHandler ? h$3(HorizontalEventResizeIcon, {
...
function AlldayGridRow({
  ...
  const horizontalEvents = F$2(() => events.filter(isWithinHeight(height, EVENT_HEIGHT + WEEK_EVENT_MARGIN_TOP)).map((uiModel) => h$3(HorizontalEvent, {
  ...
  }, horizontalEvents), h$3(ResizingEventShadow, {
    weekDates,
    gridPositionFinder,
    gridColWidthMap
  }), h$3(MovingEventShadow$2, {
    rowStyleInfo,
    gridPositionFinder
  }), h$3(AlldayGridSelection, {
    weekDates,
    narrowWeekend
  })));
}
...
function EventDetailSectionDetail({ event }) {
  ...
  return h$3("div", {
    ...
    className: classNames$j.content
  }, (_b = calendar == null ? void 0 : calendar.name) != null ? _b : "")), body && h$3("div", {
...
var DetailPopupArrowDirection = ((DetailPopupArrowDirection2) => {
...
var FormPopupArrowDirection = ((FormPopupArrowDirection2) => {
...
function FloatingLayerProvider({ children }) {
  ...
  return h$3(FloatingLayerContext.Provider, {
    value: floatingLayer
  }, children, h$3("div", {
...
function EventDetailPopup() {
  ...
  }, h$3(EventDetailSectionHeader, {
    event
  }), h$3(EventDetailSectionDetail, {
    event
  }), !isReadOnly && h$3("div", {
...
function CalendarDropdownMenu({ calendars, setOpened, onChangeIndex }) {
  ...
  }, calendars.map(({ name, backgroundColor = "000" }, index) => h$3(DropdownMenuItem, {
...
var FormStateActionType = ((FormStateActionType2) => {
...
function CalendarSelector({ calendars, selectedCalendarId, formStateDispatch }) {
  ...
  })), isOpened && h$3(CalendarDropdownMenu, {
    calendars,
    setOpened,
...
var DateSelector = R(function DateSelector2({ start, end, isAllday: isAllday2 = false, formStateDispatch }, ref) {
  ...
  return h$3(PopupSection, null, h$3("div", {
...
function EventStateSelector({ eventState = "Busy", formStateDispatch }) {
  ...
  }, eventState === "Busy" ? h$3(Template, {
    template: "popupStateBusy"
  }) : h$3(Template, {
    template: "popupStateFree"
  })), h$3("span", {
    className: classNames$a.arrowIcon
  })), isOpened && h$3(StateDropdownMenu, {
    setOpened,
...
function EventFormPopup() {
  ...
  return V(h$3("div", {
  ...
  }, (calendars == null ? void 0 : calendars.length) ? h$3(CalendarSelector, {
    selectedCalendarId: formState.calendarId,
    calendars,
    formStateDispatch
  }) : h$3(PopupSection, null), h$3(TitleInputBox, {
    title: formState.title,
    isPrivate: formState.isPrivate,
    formStateDispatch
  }), h$3(LocationInputBox, {
    ...
    formStateDispatch,
    ref: datePickerRef
  }), h$3(EventStateSelector, {
    eventState: formState.state,
    formStateDispatch
  }), h$3(ClosePopupButton, {
    type: "form",
    close
  }), h$3(PopupSection, null, h$3(ConfirmPopupButton, null, isCreationPopup ? h$3(Template, {
    template: "popupSave"
  }) : h$3(Template, {
...
function SeeMoreEventsPopup() {
  ...
  }, events.map((uiModel) => h$3(HorizontalEvent, {
...
function Layout({
  ...
  return h$3(LayoutContainerProvider, {
    value: container
  }, h$3("div", {
    ref: containerRefCallback,
    className: layoutClassName,
    style: __spreadProps(__spreadValues({}, getLayoutStylesFromInfo(width, height)), { backgroundColor })
  }, container ? children : null), h$3(EventFormPopup, null), h$3(EventDetailPopup, null), h$3(SeeMoreEventsPopup, null), h$3(PopupOverlay, null));
}
...
var Panel = R(function Panel2({
  ...
  return h$3(p$3, null, h$3("div", {
    ...
    style: styles,
    ref
  }, children), isResizable ? h$3(PanelResizer, {
    name,
    width: resizerWidth,
...
function TimeEvent({
  ...
  })) : null, comingDurationHeight ? h$3("div", {
    className: classNames$5.travelTime,
    style: comingDurationStyle
  }, h$3(Template, {
    template: "comingDuration",
    param: model
  })) : null, shouldShowResizeHandle ? h$3("div", {
...
function GridSelectionByColumn({ columnIndex, timeGridRows }) {
  ...
  return h$3(GridSelection, __spreadValues({}, gridSelectionProps));
}
...
function VerticalEvents({
  ...
  return h$3("div", {
    ...
    style
  }, eventUIModels.map((eventUIModel) => h$3(TimeEvent, {
...
var Column = g$1(function Column2({
  columnDate,
  columnWidth,
  columnIndex,
  totalUIModels,
  ...
  return h$3("div", {
    ...
    minEventHeight
  }), h$3(ResizingGuideByColumn, {
    gridPositionFinder,
    totalUIModels,
    columnIndex,
    timeGridData
  }), h$3(GridSelectionByColumn, {
    columnIndex,
    timeGridRows
  }));
});
...
var GridLines = g$1(function GridLines2({
  timeGridRows
}) {
...
function NowIndicatorLabel({ unit, top, now, zonedNow }) {
  ...
  }, dateDifference !== 0 && h$3("span", {
    className: cls(classNames$2.dayDifference)
  }, `[${dateDifference > 0 ? "+" : "-"}${Math.abs(dateDifference)}]`), h$3(Template, {
...
function HourRows({ rowsInfo, isPrimary, borderRight, width, nowIndicatorState }) {
  ...
  }), showNowIndicator && isPresent(nowIndicatorState) && isPresent(zonedNow) && h$3(NowIndicatorLabel, {
    unit: "hour",
...
var TimeColumn = g$1(function TimeColumn2({ timeGridRows, nowIndicatorState }) {
  ...
  }, !timezonesCollapsed && otherTimezoneHourRowsProps.map((rowsInfo) => h$3(HourRows, {
...
function TimeGrid({ timeGridData, events }) {
  ...
  return h$3("div", {
    ...
    timeGridRows: rows
  }), h$3(MovingEventShadow$1, {
    gridPositionFinder,
    timeGridData
  }), columns.map((column, index) => h$3(Column, {
  ...
  })), showNowIndicator && isPresent(currentDateData) && isPresent(nowIndicatorState) ? h$3(NowIndicator, {
    top: nowIndicatorState.top,
...
function Day$1() {
  ...
  const gridRows = activePanels.map((key) => {
    ...
    }, rowType === "allday" ? h$3(AlldayGridRow, {
  ...
  return h$3(Layout, {
    ...
    rowStyleInfo
  })), gridRows, activePanels.includes("time") ? h$3(Panel, {
    name: "time",
    autoSize: 1,
    ref: setTimePanelRef
  }, h$3(TimeGrid, {
...
function AccumulatedGridSelection({ rowIndex, weekDates, narrowWeekend }) {
  ...
  }, gridSelectionDataByRow.map((gridSelectionData) => gridSelectionData ? h$3(GridSelection$1, {
    type: "accumulated",
    gridSelectionData,
    weekDates,
    narrowWeekend
...
function CellHeader({
  ...
  return h$3("div", {
    ...
    param: templateParam
  })), exceedCount ? h$3(MoreEventsButton, {
    type,
    number: exceedCount,
...
var GridRow = g$1(function GridRow2({
  week,
  rowInfo,
  gridDateEventModelMap = {},
  contentAreaHeight
...
var MonthEvents = g$1(function MonthEvents2({
  contentAreaHeight,
  eventHeight = EVENT_HEIGHT,
  events,
  name,
  ...
  const dayEvents = events.filter(isWithinHeight(contentAreaHeight, eventHeight + MONTH_EVENT_MARGIN_TOP)).map((uiModel) => h$3(HorizontalEvent, {
...
function DayGridMonth({ dateMatrix = [], rowInfo = [], cellWidthMap = [] }) {
  ...
  return h$3("div", {
    ...
    return h$3("div", {
      ...
      eventHeight: MONTH_EVENT_HEIGHT,
      className: cls("weekday-events")
    }), h$3(GridSelectionByRow, {
      weekDates: week,
      narrowWeekend,
      rowIndex
    }), h$3(AccumulatedGridSelection, {
      rowIndex,
      weekDates: week,
      narrowWeekend
    })), h$3(ResizingGuideByRow, {
      dateMatrix,
      gridPositionFinder,
      rowIndex,
      cellWidthMap,
      renderedUIModels: renderedEventUIModels
    }), h$3(MovingEventShadow, {
      dateMatrix,
      gridPositionFinder,
      rowIndex,
      rowInfo
...
function Week$1() {
  ...
  return h$3(Layout, {
    ...
    options: weekOptions,
    rowStyleInfo
  })), dayGridRows, hasTimePanel ? h$3(Panel, {
    name: "time",
    autoSize: 1,
    ref: setTimePanelRef
  }, h$3(TimeGrid, {
...
function Main() {
  ...
  return h$3(CurrentViewComponent, null);
}
...
function CalendarContainer({ theme, store, eventBus, children }) {
  return h$3(EventBusProvider, {
    value: eventBus
  }, h$3(ThemeProvider, {
    store: theme
  }, h$3(StoreProvider, {
    store
  }, h$3(FloatingLayerProvider, null, children))));
}
...
var CalendarCore = class {
  ...
  renderToString() {
    return m(h$3(CalendarContainer, {
      theme: this.theme,
      store: this.store,
      eventBus: this.eventBus
    }, this.getComponent()));
...
@toast-ui/calendar/dist/toastui-calendar.mjs:
  (*!
